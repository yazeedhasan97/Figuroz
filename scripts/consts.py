...
DB_CONFIG_FILE = os.path.join(ENV_DIR, 'local.ini')
DB_PATH = os.path.join(ENV_DIR, 'local.db')

FORGET_PASSWORD_HEIGHT = 200
FORGET_PASSWORD_WIDTH = 340

LOGIN_PASSWORD_HEIGHT = 200
LOGIN_PASSWORD_WIDTH = 500

DURATIONS_UPLOAD_INTERVAL = 60  # 5 MIN
